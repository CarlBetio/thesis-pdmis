                                                    ...
                                                    <div class="row clearfix">
                                                       <div class="col-lg-offset-3 col-md-offset-3 col-sm-offset-3 col-xs-offset-3">
                                                           ...
                                                           <button type="submit" class="btn bg-grey m-t-15 waves-effect" name="dialysisdetail2" style="width:81%; color:black">Patient Weight Summary</button> <br>
                                                             <button type="submit" class="btn bg-grey m-t-15 waves-effect" name="dialysisdetail3" style="width:70%; color:black">Illness & Operation</button>&nbsp;<button class="btn bg-grey m-t-15 waves-effect"> <i class="material-icons">equalizer</i></button><br>
                                                             <button type="submit" class="btn bg-grey m-t-15 waves-effect" name="dialysisdetail4" style="width:70%; color:black">Personal/Social History</button>&nbsp;<button class="btn bg-grey m-t-15 waves-effect" id="psh"> <i class="material-icons">equalizer</i></button><br>
                                                            <button type="submit" class="btn bg-grey m-t-15 waves-effect" name="dialysisdetail5" style="width:70%; color:black">ESRD Causes</button>&nbsp;<button class="btn bg-grey m-t-15 waves-effect"> <i class="material-icons">equalizer</i></button><br>
                                                            <button type="submit" class="btn bg-grey m-t-15 waves-effect" name="dialysisdetail6" style="width:70%; color:black">Access</button>&nbsp;<button class="btn bg-grey m-t-15 waves-effect"> <i class="material-icons">equalizer</i></button><br>
                                                           <button type="submit" class="btn bg-grey m-t-15 waves-effect" name="dialysisdetail7" style="width:70%; color:black">Patient Population Statistics</button>&nbsp;<button class="btn bg-grey m-t-15 waves-effect" onclick="location.href='PatientProfile.php'"> <i class="material-icons">trending_up</i></button><br>
                                                        </div>
                                                    </div>
                                                </form>
